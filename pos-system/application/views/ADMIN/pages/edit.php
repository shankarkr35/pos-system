              ...
              <div class="card-header">
                ...
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="name-en" placeholder="Page Title (English).*" value="<?php echo $page->title_en?>">
                    <span class="text-danger font-weight-bold" id="name-err"></span>
                  </div>
                  <div class="form-group">
                    <label for="exampleInputPassword1">Page Title (Arabic) :</label>
                    <input type="text" class="form-control arabic-input" id="name-ar" placeholder="Page Title (Arabic).*" value="<?php echo $page->title_ar?>">
                    <span class="text-danger font-weight-bold" id="ar_name-err"></span>
                  </div>
                   <div class="form-group">
                      <label for="postDescription">Description (en)</label>
                      <textarea id="postDescription" name="postDescription" class="form-control" rows="3"><?php echo $page->en_desc?></textarea>
                    </div>
                    <div class="form-group">
                      <label for="postDescription">Description (ar)</label>
                      <textarea id="arpostDescription" name="arpostDescription" class="form-control arabic-input" rows="3"><?php echo $page->ar_desc?></textarea>
                    </div>
                </div>
        ...
        if(name!=""&&ar_name!="")
        {
            ...
            $.ajax({
                ...
                success: function(jsonStr) {
                  ...
                  if ((responseData != null) && (responseData == 'page updated')) 
                  {

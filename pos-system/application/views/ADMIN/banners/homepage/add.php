        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Create New Homepage Slider</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-md-12">
            <div class="card card-danger">
              <div class="card-header">
                <h3 class="card-title">Create New Homepage Slider</h3>
              </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <div class="select2-danger">
                                    <select id="events" class="select2 form-control-sm" data-placeholder="Events." data-dropdown-css-class="select2-danger" style="width: 100%;">
                                      ...
                                      <option value="<?php echo $row->event_id?>"><?php echo $row->en_event_title?></option>
                                      <?php endforeach?>
                                    </select>
                                </div>
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <div class="white-box">
                                    <input type="file" id="file" name="file" class="dropify" data-default-file="" accept="image/png, image/gif, image/jpeg"/> 
                                </div>
...
<script>
    $(document).on('click','#save-btn-custom',function(){
        ...
        if(img=="")
        {
            $('#image-err').text('Please select slider image.*');
        }else{
            $('#image-err').text('');
        }
        if(img!="")
        {
            ...
            $.ajax({
                url: baseUrl + "insert-home-slider",
                type: "POST",
                data: fd,
                contentType: false,
                processData: false,

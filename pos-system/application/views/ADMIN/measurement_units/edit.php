        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Edit Measurement Unit</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
              ...
              <div class="card-header">
                ...
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="name-en" value="<?php echo $unit->name?>">
...
<script>
    $(document).on('click','#save-btn-custom',function(){
        ...
        if(name!="")
        {
            ...
            var fd = new FormData();
            fd.append('id',<?php echo $unit->id?>);
            fd.append('name',name);
        
            $.ajax({
                url: baseUrl + "update-unit",
                type: "POST",
                data: fd,
                contentType: false,
                processData: false,

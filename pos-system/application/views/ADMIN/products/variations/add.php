        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">New Product Variation</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-md-12">
            <div class="card card-danger">
              <div class="card-header">
                <h3 class="card-title">New Product Variation</h3>
              </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-md">
                            ...
                            <div class="form-group">
                              ...
                              <input type="text" id="productPrice" name="productPrice" class="form-control-sm form-control">
                              <span class="error-text" id="productPriceError"></span>
                            </div>
                            <div class="form-group">
                              <label for="productSalePrice">Sale Price</label>
                              <input type="text" id="productSalePrice" name="productSalePrice" class="form-control-sm form-control">
                        ...
                        <div class="col-md">
                            <div class="form-group">
                              ...
                              <div class="white-box">
                                <input type="file" id="featuredImage" name="file" class="dropify" data-default-file="<?php echo base_url(); ?>uploads/products/medium/<?php echo 'default-image.png'; ?>" onchange="checkFile()" /> 
...
<script>
    ...
    $('#save-btn-custom').on('click', function(event) {
            ...
            if ((productId != '') && (productSalePrice != '') && (productSalePrice != '0')  && (files != '')) 
            {
                ...
                $.ajax({
                    url: baseUrl + "admin/Variations/create",
                    type: "POST",
                    data: fd,
                    contentType: false,
                    processData: false,
                    ...
                    success: function(jsonStr) {
                      ...
                      if ((responseData != null) && (responseData == 'variation created successfully')) {

              ...
              <div class="card-header">
                ...
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="name" placeholder="Enter name.*" value="<?php echo $customer->customer_name ?>">
                    <span class="text-danger font-weight-bold" id="name-err"></span>
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Email :</label>
                    <input type="text" class="form-control" id="email" placeholder="Enter email.*" value="<?php echo $customer->email ?>">
                    <span class="text-danger font-weight-bold" id="email-err"></span>
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Mobile :</label>
                    <input type="number" class="form-control" id="mobile" placeholder="Enter mobile.*" value="<?php echo $customer->mobile_number ?>">
                  ...
                  <div style="display:none;" class="form-group">
                   ...
                   <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="address" placeholder="Enter address.*" value="<?php echo $customer->address ?>">
                    <span class="text-danger font-weight-bold" id="address-err"></span>
                  </div>
                  <div class="form-group">
                    <label for="exampleInputFile">Image :</label>
                    <div class="white-box">
                        <input type="file" id="file" name="file" class="dropify" data-default-file="<?php echo base_url(); ?>uploads/members/<?php echo $customer->image; ?>" /> 
                    </div>
                  </div>
                </div>
...
<script>
    $(document).on('click','#save-btn-custom',function(){
        ...
        if(name!="" && email!="" && mobile!="" && (isEmail($('#email').val())))
        {
            ...
            fd.append('id',"<?php echo $customer->id?>");
            $.ajax({

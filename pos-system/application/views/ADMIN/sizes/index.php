                ...
                <table id="custom-data-table" class="table table-bordered table-striped">
                  ...
                  ?>  
                    <tr id="row<?php echo $row->id?>">
                        ...
                        <td>
                            <a href="<?php echo base_url('edit-size/').$row->id?>" class="btn btn-info btn-sm"><i class="fas fa-edit"></i></a>
...
<script>
    ...
    $(document).on('click','#add-new-btn',function(){
        ...
        window.location.replace(base_url+"add-new-size");
    });
</script> 
...
<script>
    $(function(){
        ...
        if ( sessionStorage.getItem('updated') ) {
           swal({
              title: "Size Updated.",
              text: "Size Details updated successfully.!",
              type: "success",
              confirmButtonClass: 'btn-primary btn-sm',
              confirmButtonText: 'OK'
            });

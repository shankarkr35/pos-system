              ...
              <div class="card-header">
                ...
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="name-en" placeholder="Name English.*" value="<?php echo $category->name?>">
                    <span class="text-danger font-weight-bold" id="name-err"></span>
                  </div>
                  <div class="form-group">
                    <label for="exampleInputFile">Category Image :</label>
                    <div class="white-box">
                        <input type="file" id="file" name="file" class="dropify" data-default-file="<?php echo base_url(); ?>uploads/categories/medium/<?php echo $category->image ?>" /> 
                    </div>
                  </div>
                </div>
...
<script>
    $(document).on('click','#save-btn-custom',function(){
        ...
        if(name!="")
        {
            ...
            fd.append('name',name);
            fd.append('id',"<?php echo $category->id?>");
            $.ajax({

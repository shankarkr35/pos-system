    ...
    <div class="d-flex flex-row">
        ...
        <div class="d-flex align-items-center justify-content-center active" style="height:9.5rem;">
            <img class="img-responsive" style="height:100%;width:auto;overflow:hidden;border-radius: 5%;"
                 src="<?php echo $response['image'] ?>"
                 onerror="this.src='<?php echo $response['image'] ?>'"
                 data-zoom="<?php echo $response['image'] ?>"
                 alt="Product image" width="">
            <div class="cz-image-zoom-pane"></div>
        </div>
        <!-- Product details-->
        <div class="details pl-2">
            <span class="product-name"><a href="#" class="h3 mb-2 product-title"><?php echo $response['name'] ?></a></span>

            <div class="mb-3 text-dark">
                <span class="h3 font-weight-normal text-accent mr-1">
                    <?php echo $response['price'] ?>
                </span>
                <?php if($response['discount'] > 0){ ?>
                    <strike style="font-size: 12px!important;">
                        <?php echo $response['mrp_price'] ?>
                    </strike>
                <?php } ?>
            </div>
            ...
            <?php if($response['discount'] > 0){ ?>
                <div class="mb-3 text-dark">
                    ...
                    <strong
                        id="set-discount-amount"><?php echo $response['discount'] ?></strong>
                </div>
           <?php } ?>
        <!-- Product panels-->
    ...
    <div class="row pt-2">
        <div class="col-12">
            ...
            <form id="add-to-cart-form" class="mb-2">
                <!--@csrf-->
                <input type="hidden" name="id" value="<?php echo $response['product_id'] ?>">
                <input type="hidden" name="variationId" value="<?php echo $response['variation_id'] ?>">
            ...
            <!-- Quantity + Add to cart -->
                <div class="d-flex justify-content-between">
                    <div class="product-description-label mt-2 text-dark h3">Quantity:</div>
